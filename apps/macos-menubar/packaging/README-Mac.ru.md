...
После запуска в окне Murmur выберите существующую папку профиля. До выбора
профиля в кратком меню только «Выбрать папку профиля…» и «Выход»; после выбора
появляются состояние и доступное управление.
